...
let DeviceTokenService = DeviceTokenService_1 = class DeviceTokenService {
    ...
    async upsertDeviceToken(userId, deviceToken) {
        ...
        try {
            ...
            await pool.query(`INSERT INTO device_tokens (user_id, device_token, platform, is_active, last_used_at, created_at, updated_at, pending_key)
         ...
         DO UPDATE SET
           ...
           last_used_at = NOW(),
           updated_at = NOW(),
           pending_key = NULL`, [userId, deviceToken.trim()]);
