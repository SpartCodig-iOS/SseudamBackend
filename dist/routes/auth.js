...
if (!SUPABASE_URL || !SUPABASE_SERVICE_ROLE_KEY) {
    ...
    console.warn('[auth] SUPABASE_URL 또는 SUPABASE_SERVICE_ROLE_KEY 가 설정되어 있지 않습니다. Supabase 연동 기능이 비활성화됩니다.');
}
...
router.post('/refresh', async (req, res) => {
    ...
    try {
        ...
        // Refresh token 검증
        const payload = (0, jwtService_1.verifyRefreshToken)(refreshToken);
        if (!payload.sub) {
